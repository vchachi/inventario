            ...
            <div class="w-38 tr relative">
                <div class="top">
                    <div class="mb-10 tl w-70">
                        ...
                        <h5 class="mb-10"><span style="color: #115a9f">NÚMERO FACTURA:</span> {{$sales->id}}</h5>
                        <h5><span style="color: #115a9f">FECHA FACTURA:</span> {{$sales->date}}</h5>
                    </div>
                    <div class="mt-10 tl  w-70">
                        <h4 class="m-0" style="color: #115a9f">DESTINATARIO:</h4>
                        <p class="m-0">{{$clientsOption->fullname}}</p>
                        <p class="m-0">NIF: {{$clientsOption->NIF}}</p>
                        <p class="m-0">{{$clientsOption->address}}</p>
                        <p class="m-0">{{$clientsOption->email}}</p>
                        <p class="m-0">Telf: {{$clientsOption->phone}}</p>
                    </div>
                </div>
            </div>
        </div>
