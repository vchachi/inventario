            ...
            <div class="w-38 tr relative">
                <div class="top">
                    <div class="mb-10 tl w-70">
                        ...
                        <h5 class="mb-10"><span style="color: #115a9f">NÚMERO FACTURA RECTIFICATIVA</span> {{$ventas->saleid}}</h5>
                        <h5><span style="color: #115a9f">FECHA FACTURA RECTIFICATIVA:</span> {{$ventas->date}}</h5>
                    </div>
        ...
        <div class="row mt-10" style="height: 190px;">
            <div class="w-40 mt-10 mb-10 relative">
                <div class="top" style="top: 60px;">   
                    ...
                    <p>{{$ventas->forma_pago=='1'?'Efectivo': ($sventasales->forma_pago=='2'?'Tarjeta':($ventas->forma_pago=='3'?'Bizum':'Transferencia'))}}</p>
                </div>
            </div>
