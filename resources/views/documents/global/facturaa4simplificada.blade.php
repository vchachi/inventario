...
@foreach ($sales as $ventas)
    <div class="container">
        <div class="row mb-10" style="min-height: 290px;">
          ...
          <img style="width:100px;height:100px;" src="{{$image}}" /></h2></div>
                    <div class="mt-10">
            ...
            <div class="w-38 tr relative">
                <div class="top">
                    <div class="mb-10 tl w-70">
                        <h5 class="mb-10"><span style="color: #115a9f">FACTURA SIMPLIFICADA:</span> {{$ventas->saleid}}</h5>
                        <h5><span style="color: #115a9f">FECHA:</span> {{$ventas->date}}</h5>
                    </div>
