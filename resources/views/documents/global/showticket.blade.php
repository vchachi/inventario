    ...
    <div class="row">
      <div class="col-lg-12"style="font-size:10px;margin:3px 0px 0px 0px">
        <div>
          ...
          <p style="font-size:10px;margin:3px 0px 0px 0px"><span style="font-weight:900">Nº Factura:</span> {{$ventas->salesid}}</p>
        ...
        <div>
          <p style="font-size:10px;margin:3px 0px 0px 0px"><span style="font-weight:900">Nombre:</span> {{$ventas->fullname}}</p>
          <p style="font-size:10px;margin:3px 0px 0px 0px"><span style="font-weight:900">NIF:</span> {{$ventas->NIF}}</p>
          <p style="font-size:10px;margin:3px 0px 0px 0px"><span style="font-weight:900">Dirección:</span> {{$ventas->address}}</p>
          <p style="font-size:10px;margin:3px 0px 0px 0px"><span style="font-weight:900">Teléfono:</span> {{$ventas->phone}}</p>
        </div>
         <hr style="font-size:10px;margin:3px 0px 0px 0px">
         <div>
