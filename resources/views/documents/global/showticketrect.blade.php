    ...
    <div class="row">
      <div class="col-lg-12"style="font-size:10px;margin:3px 0px 0px 0px">
        <div>
          ...
          <p style="font-size:10px;margin:3px 0px 0px 0px"><span style="font-weight:900">Nº Factura Rectificativa:</span> {{$ventas->salesid}}</p>
        ...
        <div>
          ...
          <p ><span style="font-weight:900">Dirección:</span> {{$ventas->address}}</p>
