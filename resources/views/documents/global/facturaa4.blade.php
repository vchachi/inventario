    ...
    <div class="container">
            ...
            <div class="w-38 tr relative">
                <div class="top">
                    <div class="mb-10 tl w-70">
                        ...
                        <h5 class="mb-10"><span style="color: #115a9f">NÚMERO FACTURA:</span> {{$ventas->saleid}}</h5>
                        <h5><span style="color: #115a9f">FECHA FACTURA:</span> {{$ventas->date}}</h5>
                    </div>
                    <div class="mt-10 tl  w-70">
                        <h4 class="m-0" style="color: #115a9f">DESTINATARIO:</h4>
                        <p class="m-0">{{$ventas->fullname}}</p>
                        <p class="m-0">NIF: {{$ventas->NIF}}</p>
                        <p class="m-0">{{$ventas->address}}</p>
                        <p class="m-0">{{$ventas->email}}</p>
                        <p class="m-0">Telf: {{$ventas->phone}}</p>
                    </div>
                </div>
            </div>
        </div>
        <div class="row mt-10" style="padding-bottom: 10px; border-bottom: 2px solid #115a9f;">
         ...
         <ul>
                ...
                <li class="space w-10 td-bg tc p-5">{{ $producto->price }} €</li>
                <li class="space w-10 td-bg tc p-5">0</li>
                <li class="space w-10 td-bg tc p-5">{{$producto->subtotal}} €</li>
          ...
          <ul>
                ...
                <li class="space w-10 td-bg tc p-5">{{$producto->subtotal}} €</li>
                <li class="space w-5 td-bg tc p-5">21%</li>
                <li class="space w-10 td-bg tc p-5">{{ ($producto->subtotal*0.21)+$producto->subtotal }} €</li>
            </ul>
          @endif
          @endif
        ...
        <div class="row mt-10" style="height: 190px;">
            <div class="w-40 mt-10 mb-10 relative">
                <div class="top" style="top: 60px;">   
                    ...
                    <p>{{$ventas->forma_pago=='1'?'Efectivo': ($ventas->forma_pago=='2'?'Tarjeta':($ventas->forma_pago=='3'?'Bizum':'Transferencia'))}}</p>
                </div>
            </div>
            ...
            <div class="w-40 tr relative">
                <div class="top">
                    ...
                    <ul>
                        ...
                        <li class="w-40 space td-bg tr p-5"> {{$ventas->subtotal}} €</li>
                    </ul>
                    <ul>
                        <li class="w-50 space td-bg tc p-5">Recargo</li>
                        <li class="w-40 space td-bg tr p-5">0 €</li>
                    </ul>
                    <ul>
                        <li class="w-50 space td-bg tc p-5">Total</li>
                        <li class="w-40 space td-bg tr p-5"> {{$ventas->total}}  €</li>
                    </ul>
                    <ul>
                        <li class="w-50 space tc p-5" style="color: #fff; background-color: #115a9f;">Total</li>
                        <li class="w-40 space tr p-5" style="color: #fff; background-color: #115a9f;">{{$ventas->total}} €</li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="row mr-10 ml-10" style="margin:100px 0px 0px 130px">
                <div class="w-30  m-auto">
                        <div style="padding:0px  40px 0px  0px">
                                ...
                                <p style="font-size:8px;">{{$empresa['direccion']}}</p>
                                </div>
                        </div>
                </div>
                <div class="w-30  m-auto" >
                        <div style="padding:0px  40px 0px  0px">
                                ...
                                <p style="font-size:8px;">Tel: {{$empresa['tel']}} </p>
                                </div>
                        </div>
                </div>
                <div class="w-30  m-auto">
                        <div style="padding:0px  40px 0px  0px">
                                ...
                                <div class="w-25" style="width:60%;height:25px;">
                                <p style="font-size:8px;">{{$empresa['email']}}</p>
                                <p style="font-size:8px;">{{$empresa['web']}}</p>
                                </div>
                        </div>
                </div>
        </div>
