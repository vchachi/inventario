...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'print_method'=>'Metodo de Impresion',
        'autoprint'=>'Auto Impresion',
        'head'=>'Cabeza',
        'paper_size'=>'Tamaño del Papel',
        'margin_top'=>'Margen Arriba',
        'margin_right'=>'Margen Derecho',
        'margin_bottom'=>'Margen Abajo',
        ...
        'imei_serie'=>'Numero de Serie',
        'repair_cost'=>'Coste de reparacion',
        'concept'=>'Concepto',
        'date'=>'Fecha',
        ...
        'password'=>'Clave',
        'email'=>'Correo',
        'url_conditions'=>'Url Condiciones',
        'delivery_costs'=>'Coste de envío'
    ],
